...
/*
 * OAIHandlers_ClientNotifyListResponse.h
 *
 * 
 */

#ifndef OAIHandlers_ClientNotifyListResponse_H
#define OAIHandlers_ClientNotifyListResponse_H
...
class OAIHandlers_ClientNotifyListResponse : public OAIObject {
public:
    OAIHandlers_ClientNotifyListResponse();
    OAIHandlers_ClientNotifyListResponse(QString json);
    ~OAIHandlers_ClientNotifyListResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHandlers_ClientNotifyListResponse)

#endif // OAIHandlers_ClientNotifyListResponse_H
